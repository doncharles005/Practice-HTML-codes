...
<head>
    ...
    <style>
        ...
        .wallet-info, .transaction-form, .deposit-form, .withdraw-form { 
            background: #f9f9f9;
            padding: 20px;
            border-radius: 5px;
            margin-bottom: 20px;
    ...
    <div class="withdraw-form">
        ...
        <form id="withdraw-form">
            ...
            <div>
                ...
                <input type="email" id="paypal-email" placeholder="your.email@example.com" required>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('withdraw-form').addEventListener('submit', async function(e) {
                ...
                resultDiv.innerHTML = '<p class="processing">Processing withdrawal...</p>';

                const amount = parseFloat(document.getElementById('withdraw-amount').value);
                const paypalEmail = document.getElementById('paypal-email').value.trim();

                if (!paypalEmail || isNaN(amount) || amount <= 0) {
                    resultDiv.innerHTML = '<p class="error-message">Please fill in all fields correctly.</p>';
                    return;
                }
                ...
                try {
                    ...
                    resultDiv.innerHTML = '<p class="error-message">An error occurred while processing.</p>';
                }
            });
